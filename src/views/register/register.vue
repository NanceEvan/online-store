...
<div class="c-box bg-box" >
    <div class="login-box clearfix"style="margin-top:10px">
        ...
        <div class="fr form-box">
            <div class="tab">
                <h2 class="active">帐号注册</h2>

            </div>
            <div class="tab-form">
                <form id="email_register_form" autocomplete="off">
                    <input type="hidden" name="csrfmiddlewaretoken" value="ywSlOHdiGsK6VFB6iyhnB1B30khmz8SU">

                    <div class="form-group marb8">
                        <label>邮&nbsp;箱</label>
                        <input id="jsRegemail" name="account" v-model="email" type="text" placeholder="请输入您的邮箱">
                    </div>
                    ...
                    <input class="btn btn-green" id="jsemailRegBtn" @click="isRegister" type="button" value="注册并登录">
                </form>
            </div>
...
.form-group .email-register-captcha{
    width:85px;
}
.form-group .captcha{
    cursor: pointer;
